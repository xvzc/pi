...
<instructions title="Prioritize Findings">
  ...
  <rule>Use verdict only to signal whether the review has comments.</rule>
  ...
  <severity name="critical">Bugs, security vulnerabilities, data loss risk. Must fix.</severity>
  <severity name="major">Logic errors, incorrect behavior, missing edge cases. Should fix.</severity>
